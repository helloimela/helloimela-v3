export const stories = [
  ...
  },
  {
    ...
    content:
      'In high-school, math, computer, and programming is my favorite subject at school. I was part of the national olympiad team training and I enjoyed it a lot. I always loved problem solving and logic since my teenager time. The most memorable time was when I participated another web design competition, I was the only woman in the competition but I was blessed to achieve the first place. And the jury, was also a woman, an IT senior in a big state-owned company, told me to keep striving and that the world needs more women in IT. It motivated me even more to learn about programming.',
  ...
  },
  {
    ...
    title: 'Dare to dream',
    content:
      'Because of my passion of computer and engineering, I continued my study in Informatics Engineering at Duta Wacana Christian University. It’s a small private university in my hometown, a small city called Yogyakarta. Even though I didn’t went into any prestigious public university like my friends did (it is a big thing in my culture to go to public university), it didn’t stop me to dream big. I keep learning and keep dreaming that someday I can continue to study abroad or working abroad and bring impact in a bigger tech scene. During my bachelor’s degree, I am grateful to be granted as the awardee of Scranton’s Women Scholarship. The scholarship motivated me to learn English and motivated me to explore different opportunities outside of my comfort zone. During this time, I also learned about Human-Computer Interaction, and how important user experience is when developing a user interface.',
  ...
  },
  {
    ...
    title: 'Keep learning',
    content:
      'At KTH, I learned a lot about interaction design, UX research, UX design, and user behaviour. It completed my knowledge and sharpened my skill to deliver a great user experience in every user interface that I will build. In the summer I did an internship at Ericsson in Kista. I was tasked to do a user research around their testing system as well as contributing to the frontend code in a few testing tools. The impact from this internship was a deeper understanding about the UX issues in the daily testing workflow and suggestions on how to tackle those issues.',
  ...
  },
  {
    ...
    content:
      'My journey at Scania did not ended there. I continued to work as an employee for another 3 years. I worked for the Design System team, where we tried to establish a design system that was never existed before. During this time, my team and I established a complete technical solution for a large-scaled production ready design system. I contributed to the technical solution, building and maintaining the solution to be able to be used by other developers in the company. I was working a lot with developing web components with StencilJS and then providing the solution for other developers in different frameworks. We used Strapi Headless CMS and GraphQL to create a presentation website.',
  ...
  },
  {
    ...
    title: 'Go diving',
    content:
      'I joined H&M in 2021 in a newly built team working to create a new feature around style inspiration. We develop a new fature for hm.com website and launch our feature in several markets in Europe and the US. I was working a lot with React, Typescript, and A/B testing. We collaborated a lot in the team to plan and build the feature from scratch. I enjoyed this process a lot and we were able to ship the new feature within a short period.',
